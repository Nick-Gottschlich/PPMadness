...
export default class PartyParrot extends React.Component {
  _parrotStyle(parrotNum) {
    ...
    // import image from '../../assets/Parrots/83.gif';
    // const {width, height} = resolveAssetSource('../../assets/Parrots/83.gif');

    // console.log("width ", width)
    // console.log("height ", height)

    return {
      top: this.props.locationY - 30,
      left: this.props.locationX - 30,
    }
  }
  ...
  render() {
    ...
    return (
      <Image
        source={PARROTS[`parrot${randomNum}`]}
        style={this._parrotStyle(randomNum)} />
    )
  }
}
